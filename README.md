...
<h1 align="center">Redmine Plugin para Metric</h1>

<p align="center">
  <b>Integração oficial e Fonte de Dados Local-First para gestão de tarefas, apontamento de horas e metadados no Metric App.</b>
</p>

<p align="center">
  <a href="https://github.com/metric-org"><img src="https://img.shields.io/badge/Metric%20SDK-%3E%3D0.1.0-blue.svg" alt="Metric SDK" /></a>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/Gustavohps10/redmine-plugin/main/screenshots/screenshot-1.png" width="100%" alt="Interface da Integração Redmine no Metric App" />
</p>
...
* 🚀 **Timerbar & Sidebar:** Atalhos na interface do Metric para abrir tarefas no navegador e gerar logs rápidos.
* 🎨 **Tema Clássico:** Visual oficial do Redmine integrado ao modo Claro e Escuro do Metric.

---

## 🔑 Configurações do Plugin

Configurado nativamente pela interface do Metric App:
...
<p align="center">
  <sub>Licenciado sob a <a href="LICENSE">MIT License</a>. Feito para o ecossistema Metric.</sub>
</p>
